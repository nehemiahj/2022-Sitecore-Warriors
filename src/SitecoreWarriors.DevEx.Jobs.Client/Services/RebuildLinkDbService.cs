...
namespace SitecoreWarriors.DevEx.Jobs.Client.Services
{
    public class RebuildLinkDbService : IRebuildLinkDbService
    {
        ...
        public RebuildLinkDbService(ISitecoreApiClient apiClient) => _apiClient = apiClient;
          ...
          CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await _apiClient.RunQuery<string>("/sitecore/api/management", new GraphQLRequest()
            {
